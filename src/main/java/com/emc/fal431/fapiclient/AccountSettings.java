 ...
 *         &lt;element name="licenses" type="{}licenseSettings" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "accountSettings", propOrder = {
    "companyName",
    "contactInfo",
    "licenses"
})
public class AccountSettings {
     ...
     * {@link LicenseSettings }
     * 
     * 
     */
    public List<LicenseSettings> getLicenses() {
        if (licenses == null) {
            licenses = new ArrayList<LicenseSettings>();
        }

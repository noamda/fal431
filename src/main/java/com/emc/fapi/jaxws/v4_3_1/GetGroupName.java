...
@XmlType(name = "getGroupName", propOrder = {"group"})
public class GetGroupName {
    ...
    public GetGroupName(ConsistencyGroupUID group) {
        this.group = group;
    }
    ...
    public boolean equals(Object obj) {
        ...
        GetGroupName otherObj = (GetGroupName) obj;
    ...
    public String toString() {
        return "GetGroupName [group=" + this.group + "]";
    }
}

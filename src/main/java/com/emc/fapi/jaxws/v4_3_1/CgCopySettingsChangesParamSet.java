...
public class CgCopySettingsChangesParamSet {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CgCopySettingsChangesParamSet)) {
            return false;
        }
        CgCopySettingsChangesParamSet otherObj = (CgCopySettingsChangesParamSet) obj;
    ...
    public String toString() {
        return "CgCopySettingsChangesParamSet [innerSet=" + this.innerSet + "]";
    }
}

...
/*     */   {
/* 106 */     if (!(obj instanceof ValidateSetConsistencyGroupCopyPolicy)) {
/* 107 */       return false;
/*     */     }
/* 109 */     ValidateSetConsistencyGroupCopyPolicy otherObj = (ValidateSetConsistencyGroupCopyPolicy)obj;
/*     */     
...
/*     */   {
/* 131 */     return "ValidateSetConsistencyGroupCopyPolicy [groupCopy=" + this.groupCopy + ", " + "newPolicy=" + this.newPolicy + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateSetConsistencyGroupCopyPolicy.class

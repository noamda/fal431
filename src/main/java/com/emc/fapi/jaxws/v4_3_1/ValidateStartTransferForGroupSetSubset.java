...
public class ValidateStartTransferForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateStartTransferForGroupSetSubset)) {
            return false;
        }
        ValidateStartTransferForGroupSetSubset otherObj = (ValidateStartTransferForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateStartTransferForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + "]";
    }
}

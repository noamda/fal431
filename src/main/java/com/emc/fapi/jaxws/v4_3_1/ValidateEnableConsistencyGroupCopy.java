...
/*     */   {
/*  98 */     if (!(obj instanceof ValidateEnableConsistencyGroupCopy)) {
/*  99 */       return false;
/*     */     }
/* 101 */     ValidateEnableConsistencyGroupCopy otherObj = (ValidateEnableConsistencyGroupCopy)obj;
/*     */     
...
/*     */   {
/* 123 */     return "ValidateEnableConsistencyGroupCopy [groupCopy=" + this.groupCopy + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateEnableConsistencyGroupCopy.class

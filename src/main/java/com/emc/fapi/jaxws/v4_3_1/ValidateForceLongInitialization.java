...
public class ValidateForceLongInitialization {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateForceLongInitialization)) {
            return false;
        }
        ValidateForceLongInitialization otherObj = (ValidateForceLongInitialization) obj;
    ...
    public String toString() {
        return "ValidateForceLongInitialization [groupCopy=" + this.groupCopy + "]";
    }
}

...
public class GetIllegalDisableImageAccessGroupSetProblems {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalDisableImageAccessGroupSetProblems)) {
            return false;
        }
        GetIllegalDisableImageAccessGroupSetProblems otherObj = (GetIllegalDisableImageAccessGroupSetProblems) obj;
    ...
    public String toString() {
        return "GetIllegalDisableImageAccessGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

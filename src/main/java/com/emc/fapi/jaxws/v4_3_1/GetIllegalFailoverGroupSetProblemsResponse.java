...
public class GetIllegalFailoverGroupSetProblemsResponse {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalFailoverGroupSetProblemsResponse)) {
            return false;
        }
        GetIllegalFailoverGroupSetProblemsResponse otherObj = (GetIllegalFailoverGroupSetProblemsResponse) obj;
    ...
    public String toString() {
        return "GetIllegalFailoverGroupSetProblemsResponse [_return=" + this._return + "]";
    }
}

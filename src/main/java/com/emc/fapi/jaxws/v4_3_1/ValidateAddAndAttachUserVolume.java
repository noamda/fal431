...
public class ValidateAddAndAttachUserVolume {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateAddAndAttachUserVolume)) {
            return false;
        }
        ValidateAddAndAttachUserVolume otherObj = (ValidateAddAndAttachUserVolume) obj;
    ...
    public String toString() {
        return "ValidateAddAndAttachUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
    }
}

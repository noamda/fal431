...
@XmlType(name = "rollToImageForGroupSetSubset", propOrder = {"groupSetSubset", "cluster"})
public class RollToImageForGroupSetSubset {
    protected ConsistencyGroupSetSubset groupSetSubset;
    @XmlElement(nillable = true)
    protected ClusterUID cluster;

    public RollToImageForGroupSetSubset() {
    }

    public RollToImageForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RollToImageForGroupSetSubset)) {
            return false;
        }
        RollToImageForGroupSetSubset otherObj = (RollToImageForGroupSetSubset) obj;
    ...
    public String toString() {
        return "RollToImageForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + "]";
    }
}

...
/*     */   {
/* 141 */     if (!(obj instanceof AddConsistencyGroupLinkParams)) {
/* 142 */       return false;
/*     */     }
/* 144 */     AddConsistencyGroupLinkParams otherObj = (AddConsistencyGroupLinkParams)obj;
/*     */     
...
/*     */   {
/* 168 */     return "AddConsistencyGroupLinkParams [firstCopy=" + this.firstCopy + ", " + "policy=" + this.policy + ", " + "secondCopy=" + this.secondCopy + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\AddConsistencyGroupLinkParams.class

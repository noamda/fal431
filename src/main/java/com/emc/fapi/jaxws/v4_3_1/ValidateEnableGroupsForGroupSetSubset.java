...
/*     */   {
/*  98 */     if (!(obj instanceof ValidateEnableGroupsForGroupSetSubset)) {
/*  99 */       return false;
/*     */     }
/* 101 */     ValidateEnableGroupsForGroupSetSubset otherObj = (ValidateEnableGroupsForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 123 */     return "ValidateEnableGroupsForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateEnableGroupsForGroupSetSubset.class

...
public class ClusterSplittersSettingsSet {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ClusterSplittersSettingsSet)) {
            return false;
        }
        ClusterSplittersSettingsSet otherObj = (ClusterSplittersSettingsSet) obj;
    ...
    public String toString() {
        return "ClusterSplittersSettingsSet [innerSet=" + this.innerSet + "]";
    }
}

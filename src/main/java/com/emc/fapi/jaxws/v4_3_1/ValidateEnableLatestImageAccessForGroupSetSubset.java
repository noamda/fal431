...
/*     */ @XmlType(name="validateEnableLatestImageAccessForGroupSetSubset", propOrder={"groupSetSubset", "cluster", "mode", "scenario"})
/*     */ public class ValidateEnableLatestImageAccessForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public ValidateEnableLatestImageAccessForGroupSetSubset() {}
/*     */   
/*     */   public ValidateEnableLatestImageAccessForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster, ImageAccessMode mode, ImageAccessScenario scenario)
/*     */   {
...
/*     */   {
/* 164 */     if (!(obj instanceof ValidateEnableLatestImageAccessForGroupSetSubset)) {
/* 165 */       return false;
/*     */     }
/* 167 */     ValidateEnableLatestImageAccessForGroupSetSubset otherObj = (ValidateEnableLatestImageAccessForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 193 */     return "ValidateEnableLatestImageAccessForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "mode=" + this.mode + ", " + "scenario=" + this.scenario + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateEnableLatestImageAccessForGroupSetSubset.class

...
public class ValidateEnableLatestImageAccessForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateEnableLatestImageAccessForGroupSetSubset)) {
            return false;
        }
        ValidateEnableLatestImageAccessForGroupSetSubset otherObj = (ValidateEnableLatestImageAccessForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateEnableLatestImageAccessForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "mode=" + this.mode + ", " + "scenario=" + this.scenario + "]";
    }
}

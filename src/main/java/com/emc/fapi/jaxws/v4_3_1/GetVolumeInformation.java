...
/*     */ @XmlType(name="getVolumeInformation", propOrder={"cluster", "volumeID"})
...
/*     */   
/*     */   public GetVolumeInformation(ClusterUID cluster, DeviceUID volumeID)
/*     */   {
...
/*     */   {
/* 106 */     if (!(obj instanceof GetVolumeInformation)) {
/* 107 */       return false;
/*     */     }
/* 109 */     GetVolumeInformation otherObj = (GetVolumeInformation)obj;
/*     */     
...
/*     */   {
/* 131 */     return "GetVolumeInformation [cluster=" + this.cluster + ", " + "volumeID=" + this.volumeID + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\GetVolumeInformation.class

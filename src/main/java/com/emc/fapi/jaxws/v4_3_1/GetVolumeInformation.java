...
public class GetVolumeInformation {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetVolumeInformation)) {
            return false;
        }
        GetVolumeInformation otherObj = (GetVolumeInformation) obj;
    ...
    public String toString() {
        return "GetVolumeInformation [cluster=" + this.cluster + ", " + "volumeID=" + this.volumeID + "]";
    }
}

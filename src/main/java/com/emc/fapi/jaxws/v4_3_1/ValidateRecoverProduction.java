...
public class ValidateRecoverProduction {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateRecoverProduction)) {
            return false;
        }
        ValidateRecoverProduction otherObj = (ValidateRecoverProduction) obj;
    ...
    public String toString() {
        return "ValidateRecoverProduction [groupCopy=" + this.groupCopy + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

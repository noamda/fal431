...
public class StartGroupCopyTransfer {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof StartGroupCopyTransfer)) {
            return false;
        }
        StartGroupCopyTransfer otherObj = (StartGroupCopyTransfer) obj;
    ...
    public String toString() {
        return "StartGroupCopyTransfer [groupCopy=" + this.groupCopy + "]";
    }
}

...
/*     */ @XmlType(name="getIllegalFailoverGroupSetProblems", propOrder={"groupSetSubset", "cluster", "startTransfer"})
/*     */ public class GetIllegalFailoverGroupSetProblems
/*     */ {
...
/*     */   
/*     */   public GetIllegalFailoverGroupSetProblems() {}
/*     */   
/*     */   public GetIllegalFailoverGroupSetProblems(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof GetIllegalFailoverGroupSetProblems)) {
/* 129 */       return false;
/*     */     }
/* 131 */     GetIllegalFailoverGroupSetProblems otherObj = (GetIllegalFailoverGroupSetProblems)obj;
/*     */     
...
/*     */   {
/* 155 */     return "GetIllegalFailoverGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\GetIllegalFailoverGroupSetProblems.class

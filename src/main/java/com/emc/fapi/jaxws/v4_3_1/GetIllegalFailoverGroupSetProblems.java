...
public class GetIllegalFailoverGroupSetProblems {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalFailoverGroupSetProblems)) {
            return false;
        }
        GetIllegalFailoverGroupSetProblems otherObj = (GetIllegalFailoverGroupSetProblems) obj;
    ...
    public String toString() {
        return "GetIllegalFailoverGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

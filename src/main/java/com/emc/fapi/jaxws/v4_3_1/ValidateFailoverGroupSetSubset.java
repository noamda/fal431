...
/*     */   {
/* 128 */     if (!(obj instanceof ValidateFailoverGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     ValidateFailoverGroupSetSubset otherObj = (ValidateFailoverGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "ValidateFailoverGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateFailoverGroupSetSubset.class

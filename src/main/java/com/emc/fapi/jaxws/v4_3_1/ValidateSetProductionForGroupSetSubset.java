...
public class ValidateSetProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateSetProductionForGroupSetSubset)) {
            return false;
        }
        ValidateSetProductionForGroupSetSubset otherObj = (ValidateSetProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateSetProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

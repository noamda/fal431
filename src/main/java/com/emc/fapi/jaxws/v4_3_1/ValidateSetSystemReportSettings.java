...
public class ValidateSetSystemReportSettings {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateSetSystemReportSettings)) {
            return false;
        }
        ValidateSetSystemReportSettings otherObj = (ValidateSetSystemReportSettings) obj;
    ...
    public String toString() {
        return "ValidateSetSystemReportSettings [settings=" + this.settings + ", " + "requestedSmtpServerAddress=" + this.requestedSmtpServerAddress + "]";
    }
}

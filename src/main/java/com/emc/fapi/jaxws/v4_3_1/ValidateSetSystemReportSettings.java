...
/*     */ @XmlType(name="validateSetSystemReportSettings", propOrder={"settings", "requestedSmtpServerAddress"})
/*     */ public class ValidateSetSystemReportSettings
/*     */ {
/*     */   protected SystemReportSettings settings;
/*     */   protected String requestedSmtpServerAddress;
/*     */   
/*     */   public ValidateSetSystemReportSettings() {}
/*     */   
/*     */   public ValidateSetSystemReportSettings(SystemReportSettings settings, String requestedSmtpServerAddress)
/*     */   {
...
/*     */   {
/* 106 */     if (!(obj instanceof ValidateSetSystemReportSettings)) {
/* 107 */       return false;
/*     */     }
/* 109 */     ValidateSetSystemReportSettings otherObj = (ValidateSetSystemReportSettings)obj;
/*     */     
...
/*     */   {
/* 131 */     return "ValidateSetSystemReportSettings [settings=" + this.settings + ", " + "requestedSmtpServerAddress=" + this.requestedSmtpServerAddress + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateSetSystemReportSettings.class

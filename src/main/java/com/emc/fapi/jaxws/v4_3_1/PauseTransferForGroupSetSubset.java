...
public class PauseTransferForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof PauseTransferForGroupSetSubset)) {
            return false;
        }
        PauseTransferForGroupSetSubset otherObj = (PauseTransferForGroupSetSubset) obj;
    ...
    public String toString() {
        return "PauseTransferForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + "]";
    }
}

...
public class GetIllegalRecoverProductionForGroupSetProblems {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalRecoverProductionForGroupSetProblems)) {
            return false;
        }
        GetIllegalRecoverProductionForGroupSetProblems otherObj = (GetIllegalRecoverProductionForGroupSetProblems) obj;
    ...
    public String toString() {
        return "GetIllegalRecoverProductionForGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

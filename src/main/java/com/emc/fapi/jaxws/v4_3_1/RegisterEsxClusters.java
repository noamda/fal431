...
public class RegisterEsxClusters {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RegisterEsxClusters)) {
            return false;
        }
        RegisterEsxClusters otherObj = (RegisterEsxClusters) obj;
    ...
    public String toString() {
        return "RegisterEsxClusters [cluster=" + this.cluster + ", " + "vcUID=" + this.vcUID + ", " + "esxClusterUIDs=" + this.esxClusterUIDs + "]";
    }
}

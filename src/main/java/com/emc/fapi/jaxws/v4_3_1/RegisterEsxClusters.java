...
/*     */ @XmlType(name="registerEsxClusters", propOrder={"cluster", "vcUID", "esxClusterUIDs"})
/*     */ public class RegisterEsxClusters
/*     */ {
/*     */   protected ClusterUID cluster;
/*     */   protected VirtualCenterUID vcUID;
/*     */   protected List<EsxClusterUID> esxClusterUIDs;
/*     */   
/*     */   public RegisterEsxClusters() {}
/*     */   
/*     */   public RegisterEsxClusters(ClusterUID cluster, VirtualCenterUID vcUID, List<EsxClusterUID> esxClusterUIDs)
/*     */   {
...
/*     */   {
/* 141 */     if (!(obj instanceof RegisterEsxClusters)) {
/* 142 */       return false;
/*     */     }
/* 144 */     RegisterEsxClusters otherObj = (RegisterEsxClusters)obj;
/*     */     
...
/*     */   {
/* 168 */     return "RegisterEsxClusters [cluster=" + this.cluster + ", " + "vcUID=" + this.vcUID + ", " + "esxClusterUIDs=" + this.esxClusterUIDs + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\RegisterEsxClusters.class

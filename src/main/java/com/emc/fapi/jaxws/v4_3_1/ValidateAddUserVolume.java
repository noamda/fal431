...
/*     */   {
/* 134 */     if (!(obj instanceof ValidateAddUserVolume)) {
/* 135 */       return false;
/*     */     }
/* 137 */     ValidateAddUserVolume otherObj = (ValidateAddUserVolume)obj;
/*     */     
...
/*     */   {
/* 161 */     return "ValidateAddUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateAddUserVolume.class

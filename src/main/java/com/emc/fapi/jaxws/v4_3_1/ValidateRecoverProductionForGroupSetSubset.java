...
public class ValidateRecoverProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateRecoverProductionForGroupSetSubset)) {
            return false;
        }
        ValidateRecoverProductionForGroupSetSubset otherObj = (ValidateRecoverProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateRecoverProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

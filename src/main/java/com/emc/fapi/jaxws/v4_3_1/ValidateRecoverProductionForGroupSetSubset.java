...
/*     */ @XmlType(name="validateRecoverProductionForGroupSetSubset", propOrder={"groupSetSubset", "cluster", "startTransfer"})
/*     */ public class ValidateRecoverProductionForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public ValidateRecoverProductionForGroupSetSubset() {}
/*     */   
/*     */   public ValidateRecoverProductionForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof ValidateRecoverProductionForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     ValidateRecoverProductionForGroupSetSubset otherObj = (ValidateRecoverProductionForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "ValidateRecoverProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateRecoverProductionForGroupSetSubset.class

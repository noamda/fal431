...
public class ResumeProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ResumeProductionForGroupSetSubset)) {
            return false;
        }
        ResumeProductionForGroupSetSubset otherObj = (ResumeProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ResumeProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

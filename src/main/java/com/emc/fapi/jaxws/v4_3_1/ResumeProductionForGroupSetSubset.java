...
/*     */ @XmlType(name="resumeProductionForGroupSetSubset", propOrder={"groupSetSubset", "clusterUID", "startTransfer"})
/*     */ public class ResumeProductionForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public ResumeProductionForGroupSetSubset() {}
/*     */   
/*     */   public ResumeProductionForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID clusterUID, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof ResumeProductionForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     ResumeProductionForGroupSetSubset otherObj = (ResumeProductionForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "ResumeProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ResumeProductionForGroupSetSubset.class

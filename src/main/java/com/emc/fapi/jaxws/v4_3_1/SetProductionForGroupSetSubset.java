...
/*     */ @XmlType(name="setProductionForGroupSetSubset", propOrder={"groupSetSubset", "clusterUID", "startTransfer"})
/*     */ public class SetProductionForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public SetProductionForGroupSetSubset() {}
/*     */   
/*     */   public SetProductionForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID clusterUID, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof SetProductionForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     SetProductionForGroupSetSubset otherObj = (SetProductionForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "SetProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\SetProductionForGroupSetSubset.class

...
public class SetProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof SetProductionForGroupSetSubset)) {
            return false;
        }
        SetProductionForGroupSetSubset otherObj = (SetProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "SetProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

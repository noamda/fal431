...
public class AddUserVolume {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddUserVolume)) {
            return false;
        }
        AddUserVolume otherObj = (AddUserVolume) obj;
    ...
    public String toString() {
        return "AddUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
    }
}

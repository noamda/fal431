...
/*     */ @XmlType(name="addUserVolume", propOrder={"groupCopy", "replicationSet", "volumeID"})
/*     */ public class AddUserVolume
/*     */ {
/*     */   protected ConsistencyGroupCopyUID groupCopy;
/*     */   protected ReplicationSetUID replicationSet;
/*     */   protected DeviceUID volumeID;
/*     */   
/*     */   public AddUserVolume() {}
/*     */   
/*     */   public AddUserVolume(ConsistencyGroupCopyUID groupCopy, ReplicationSetUID replicationSet, DeviceUID volumeID)
/*     */   {
...
/*     */   {
/* 134 */     if (!(obj instanceof AddUserVolume)) {
/* 135 */       return false;
/*     */     }
/* 137 */     AddUserVolume otherObj = (AddUserVolume)obj;
/*     */     
...
/*     */   {
/* 161 */     return "AddUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\AddUserVolume.class

...
/*     */   {
/* 128 */     if (!(obj instanceof FailoverGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     FailoverGroupSetSubset otherObj = (FailoverGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "FailoverGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\FailoverGroupSetSubset.class

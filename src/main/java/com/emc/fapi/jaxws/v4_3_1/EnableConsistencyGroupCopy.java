...
public class EnableConsistencyGroupCopy {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof EnableConsistencyGroupCopy)) {
            return false;
        }
        EnableConsistencyGroupCopy otherObj = (EnableConsistencyGroupCopy) obj;
    ...
    public String toString() {
        return "EnableConsistencyGroupCopy [groupCopy=" + this.groupCopy + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

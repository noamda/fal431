...
public class GetSplittersStateFromClusterResponse {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSplittersStateFromClusterResponse)) {
            return false;
        }
        GetSplittersStateFromClusterResponse otherObj = (GetSplittersStateFromClusterResponse) obj;
    ...
    public String toString() {
        return "GetSplittersStateFromClusterResponse [_return=" + this._return + "]";
    }
}

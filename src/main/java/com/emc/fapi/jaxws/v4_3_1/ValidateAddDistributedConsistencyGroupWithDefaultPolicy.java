...
public class ValidateAddDistributedConsistencyGroupWithDefaultPolicy {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateAddDistributedConsistencyGroupWithDefaultPolicy)) {
            return false;
        }
        ValidateAddDistributedConsistencyGroupWithDefaultPolicy otherObj = (ValidateAddDistributedConsistencyGroupWithDefaultPolicy) obj;
    ...
    public String toString() {
        return "ValidateAddDistributedConsistencyGroupWithDefaultPolicy [groupName=" + this.groupName + ", " + "primaryRPA=" + this.primaryRPA + ", " + "secondaryRPAsList=" + this.secondaryRPAsList + "]";
    }
}

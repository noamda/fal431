...
/*     */ @XmlType(name="validateAddDistributedConsistencyGroupWithDefaultPolicy", propOrder={"groupName", "primaryRPA", "secondaryRPAsList"})
/*     */ public class ValidateAddDistributedConsistencyGroupWithDefaultPolicy
/*     */ {
/*     */   protected String groupName;
/*     */   protected RpaUID primaryRPA;
/*     */   protected List<RpaUID> secondaryRPAsList;
/*     */   
/*     */   public ValidateAddDistributedConsistencyGroupWithDefaultPolicy() {}
/*     */   
/*     */   public ValidateAddDistributedConsistencyGroupWithDefaultPolicy(String groupName, RpaUID primaryRPA, List<RpaUID> secondaryRPAsList)
/*     */   {
...
/*     */   {
/* 141 */     if (!(obj instanceof ValidateAddDistributedConsistencyGroupWithDefaultPolicy)) {
/* 142 */       return false;
/*     */     }
/* 144 */     ValidateAddDistributedConsistencyGroupWithDefaultPolicy otherObj = (ValidateAddDistributedConsistencyGroupWithDefaultPolicy)obj;
/*     */     
...
/*     */   {
/* 168 */     return "ValidateAddDistributedConsistencyGroupWithDefaultPolicy [groupName=" + this.groupName + ", " + "primaryRPA=" + this.primaryRPA + ", " + "secondaryRPAsList=" + this.secondaryRPAsList + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateAddDistributedConsistencyGroupWithDefaultPolicy.class

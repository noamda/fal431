...
public class ValidateRemoveUserVolume {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateRemoveUserVolume)) {
            return false;
        }
        ValidateRemoveUserVolume otherObj = (ValidateRemoveUserVolume) obj;
    ...
    public String toString() {
        return "ValidateRemoveUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
    }
}

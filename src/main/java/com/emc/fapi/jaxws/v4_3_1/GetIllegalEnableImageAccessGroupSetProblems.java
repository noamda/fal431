...
public class GetIllegalEnableImageAccessGroupSetProblems {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalEnableImageAccessGroupSetProblems)) {
            return false;
        }
        GetIllegalEnableImageAccessGroupSetProblems otherObj = (GetIllegalEnableImageAccessGroupSetProblems) obj;
    ...
    public String toString() {
        return "GetIllegalEnableImageAccessGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "params=" + this.params + ", " + "scenario=" + this.scenario + "]";
    }
}

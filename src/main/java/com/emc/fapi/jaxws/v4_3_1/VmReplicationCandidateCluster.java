...
/*     */   {
/* 116 */     if (!(obj instanceof VmReplicationCandidateCluster)) {
/* 117 */       return false;
/*     */     }
/* 119 */     VmReplicationCandidateCluster otherObj = (VmReplicationCandidateCluster)obj;
/*     */     
...
/*     */   {
/* 141 */     return "VmReplicationCandidateCluster [clusterUID=" + this.clusterUID + ", " + "virtualCentersConfiguration=" + this.virtualCentersConfiguration + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\VmReplicationCandidateCluster.class

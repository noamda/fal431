...
/*     */   {
/* 106 */     if (!(obj instanceof ValidateRenameSystemEventLogsFilter)) {
/* 107 */       return false;
/*     */     }
/* 109 */     ValidateRenameSystemEventLogsFilter otherObj = (ValidateRenameSystemEventLogsFilter)obj;
/*     */     
...
/*     */   {
/* 131 */     return "ValidateRenameSystemEventLogsFilter [filter=" + this.filter + ", " + "newName=" + this.newName + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateRenameSystemEventLogsFilter.class

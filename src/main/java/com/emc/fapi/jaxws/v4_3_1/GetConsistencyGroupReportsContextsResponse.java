...
public class GetConsistencyGroupReportsContextsResponse {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetConsistencyGroupReportsContextsResponse)) {
            return false;
        }
        GetConsistencyGroupReportsContextsResponse otherObj = (GetConsistencyGroupReportsContextsResponse) obj;
    ...
    public String toString() {
        return "GetConsistencyGroupReportsContextsResponse [_return=" + this._return + "]";
    }
}

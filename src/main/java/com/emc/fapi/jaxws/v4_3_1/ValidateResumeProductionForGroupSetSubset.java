...
/*     */ @XmlType(name="validateResumeProductionForGroupSetSubset", propOrder={"groupSetSubset", "clusterUID", "startTransfer"})
/*     */ public class ValidateResumeProductionForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public ValidateResumeProductionForGroupSetSubset() {}
/*     */   
/*     */   public ValidateResumeProductionForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID clusterUID, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof ValidateResumeProductionForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     ValidateResumeProductionForGroupSetSubset otherObj = (ValidateResumeProductionForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "ValidateResumeProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\ValidateResumeProductionForGroupSetSubset.class

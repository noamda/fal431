...
public class ValidateResumeProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateResumeProductionForGroupSetSubset)) {
            return false;
        }
        ValidateResumeProductionForGroupSetSubset otherObj = (ValidateResumeProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateResumeProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "clusterUID=" + this.clusterUID + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

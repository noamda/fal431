...
public class RecoverProductionForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RecoverProductionForGroupSetSubset)) {
            return false;
        }
        RecoverProductionForGroupSetSubset otherObj = (RecoverProductionForGroupSetSubset) obj;
    ...
    public String toString() {
        return "RecoverProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

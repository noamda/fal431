...
/*     */ @XmlType(name="recoverProductionForGroupSetSubset", propOrder={"groupSetSubset", "cluster", "startTransfer"})
/*     */ public class RecoverProductionForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public RecoverProductionForGroupSetSubset() {}
/*     */   
/*     */   public RecoverProductionForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof RecoverProductionForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     RecoverProductionForGroupSetSubset otherObj = (RecoverProductionForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "RecoverProductionForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\RecoverProductionForGroupSetSubset.class

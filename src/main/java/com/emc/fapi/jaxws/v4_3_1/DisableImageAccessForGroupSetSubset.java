...
/*     */ @XmlType(name="disableImageAccessForGroupSetSubset", propOrder={"groupSetSubset", "cluster", "startTransfer"})
/*     */ public class DisableImageAccessForGroupSetSubset
/*     */ {
...
/*     */   
/*     */   public DisableImageAccessForGroupSetSubset() {}
/*     */   
/*     */   public DisableImageAccessForGroupSetSubset(ConsistencyGroupSetSubset groupSetSubset, ClusterUID cluster, boolean startTransfer)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof DisableImageAccessForGroupSetSubset)) {
/* 129 */       return false;
/*     */     }
/* 131 */     DisableImageAccessForGroupSetSubset otherObj = (DisableImageAccessForGroupSetSubset)obj;
/*     */     
...
/*     */   {
/* 155 */     return "DisableImageAccessForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\DisableImageAccessForGroupSetSubset.class

...
public class DisableImageAccessForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof DisableImageAccessForGroupSetSubset)) {
            return false;
        }
        DisableImageAccessForGroupSetSubset otherObj = (DisableImageAccessForGroupSetSubset) obj;
    ...
    public String toString() {
        return "DisableImageAccessForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + ", " + "startTransfer=" + this.startTransfer + "]";
    }
}

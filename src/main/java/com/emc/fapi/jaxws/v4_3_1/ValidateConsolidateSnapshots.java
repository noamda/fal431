...
public class ValidateConsolidateSnapshots {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateConsolidateSnapshots)) {
            return false;
        }
        ValidateConsolidateSnapshots otherObj = (ValidateConsolidateSnapshots) obj;
    ...
    public String toString() {
        return "ValidateConsolidateSnapshots [groupCopy=" + this.groupCopy + ", " + "start=" + this.start + ", " + "end=" + this.end + "]";
    }
}

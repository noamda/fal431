...
/*     */   {
/* 134 */     if (!(obj instanceof EnableLatestImageAccess)) {
/* 135 */       return false;
/*     */     }
/* 137 */     EnableLatestImageAccess otherObj = (EnableLatestImageAccess)obj;
/*     */     
...
/*     */   {
/* 161 */     return "EnableLatestImageAccess [groupCopy=" + this.groupCopy + ", " + "mode=" + this.mode + ", " + "scenario=" + this.scenario + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\EnableLatestImageAccess.class

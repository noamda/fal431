...
public class GetIllegalUndoWritesForGroupSetProblems {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetIllegalUndoWritesForGroupSetProblems)) {
            return false;
        }
        GetIllegalUndoWritesForGroupSetProblems otherObj = (GetIllegalUndoWritesForGroupSetProblems) obj;
    ...
    public String toString() {
        return "GetIllegalUndoWritesForGroupSetProblems [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + "]";
    }
}

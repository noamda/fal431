...
public class VirtualDiskInformation {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof VirtualDiskInformation)) {
            return false;
        }
        VirtualDiskInformation otherObj = (VirtualDiskInformation) obj;
    ...
    public String toString() {
        return "VirtualDiskInformation [capacity=" + this.capacity + ", " + "virtualDiskId=" + this.virtualDiskId + ", " + "replicationCapabilities=" + this.replicationCapabilities + "]";
    }
}

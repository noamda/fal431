...
/*     */ @XmlType(name="VirtualDiskInformation", propOrder={"capacity", "virtualDiskId", "replicationCapabilities"})
...
/*     */   
/*     */   public VirtualDiskInformation() {}
/*     */   
/*     */   public VirtualDiskInformation(long capacity, VirtualDiskId virtualDiskId, VirtualDiskReplicationCapabilities replicationCapabilities)
/*     */   {
...
/*     */   {
/* 128 */     if (!(obj instanceof VirtualDiskInformation)) {
/* 129 */       return false;
/*     */     }
/* 131 */     VirtualDiskInformation otherObj = (VirtualDiskInformation)obj;
/*     */     
...
/*     */   {
/* 155 */     return "VirtualDiskInformation [capacity=" + this.capacity + ", " + "virtualDiskId=" + this.virtualDiskId + ", " + "replicationCapabilities=" + this.replicationCapabilities + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\davidn1\Downloads\RecoverPoint_SDK\src\main\resources\fapi_client_4_3_1.jar!\com\emc\fapi\jaxws\v4_3_1\VirtualDiskInformation.class

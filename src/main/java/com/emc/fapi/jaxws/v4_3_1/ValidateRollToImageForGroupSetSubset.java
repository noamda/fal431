...
public class ValidateRollToImageForGroupSetSubset {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ValidateRollToImageForGroupSetSubset)) {
            return false;
        }
        ValidateRollToImageForGroupSetSubset otherObj = (ValidateRollToImageForGroupSetSubset) obj;
    ...
    public String toString() {
        return "ValidateRollToImageForGroupSetSubset [groupSetSubset=" + this.groupSetSubset + ", " + "cluster=" + this.cluster + "]";
    }
}

...
public class RemoveUserVolume {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveUserVolume)) {
            return false;
        }
        RemoveUserVolume otherObj = (RemoveUserVolume) obj;
    ...
    public String toString() {
        return "RemoveUserVolume [groupCopy=" + this.groupCopy + ", " + "replicationSet=" + this.replicationSet + ", " + "volumeID=" + this.volumeID + "]";
    }
}
